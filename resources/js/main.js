...
document.getElementById('add').addEventListener('click', toDo);

document.getElementById('item').addEventListener('keyup', onEnter);
...
function renderListOnLoad(){
    ...
    for(var j = 0; j<data.completed.length;j++){
        var valueComplete = data.completed[j];
         addedToDo(valueComplete,true);     
    }
}
...
function addedToDo(text,completed){ 
